...
function ImageCircle({ className, imgSrc }) {
  return (
    <div className={`${styles.imgCircle} ${className || ''}`}>
      <img src={imgSrc} alt="Studio team" className={styles.coverImg} />
    </div>
  );
}
...
function Triangle({ className }) {
  return (
    <div className={`${styles.tri} ${className || ""}`} aria-hidden="true" />
  );
}
    ...
    <section className={styles.section} id="studio">
      ...
      <div className={styles.block}>
        ...
        <div className={`${styles.imageWrap} reveal-right`}>
          ...
          <ImageCircle imgSrc="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=600&q=80" />
